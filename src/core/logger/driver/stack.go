...
func NewStackDriver(loggerResolver func(channel string) (zapcore.Core, error)) func(driver config.Driver) (Driver, error) {
	return func(config config.Driver) (Driver, error) {
		config.Level = "debug"
